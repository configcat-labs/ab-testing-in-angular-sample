 ...
 * To update run 'ampli pull hosting_company_website'
 *
 ...
 *
 * [Full Setup Instructions](https://data.amplitude.com/codedbychavez/codedbychavez/implementation/hosting_company_website)
 */
...
export const DefaultOptions = {
  plan: {
    version: '7',
    branch: 'main',
    source: 'hosting_company_website',
    versionId: '555a33ec-a973-43d4-9f3a-220b4a6e293d'
  }
};
...
export class ProPlanClick {
  constructor() {
    this.event_type = 'pro_plan_click';
  }
}
...
export class Ampli {
   ...
   * pro_plan_click
   *
   * [View in Tracking Plan](https://data.amplitude.com/codedbychavez/codedbychavez/events/main/latest/pro_plan_click)
   *
   * Owner: Chavez Harris
   *
   ...
   * @param {MiddlewareExtra} [extra] Extra untyped parameters for use in middleware.
   */
  proPlanClick(options, extra) {
    this.track(new ProPlanClick(), options, extra);
  }
